...
const DEFAULT_TEXT_COLORS = '#000000,#e60000,#ff9900,#ffff00,#008a00,#0066cc,#9933ff,#ffffff,#facccc,#ffebcc,#ffffcc,#cce8cc,#cce0f5,#ebd6ff';

export default class TextColor extends Control {
  static requires = ['setTextColor'];
  ...
  constructor() {
    super();
    this.colors = DEFAULT_TEXT_COLORS;
...
customElements.define('kc-text-color', TextColor);

import '../../../src/components/tableControls/FieldSortHide.js';
...
const createTableWithFieldSortHide = async () => {
	...
	container.innerHTML = `
		<k-table>
			<div slot="controls">
				<k-tc-field-sort-hide></k-tc-field-sort-hide>
			</div>
		</k-table>
	`;
	...
	const control = container.querySelector('k-tc-field-sort-hide');
...
export default {
	...
	*/
	...
	'FieldSortHide: should have default maxWidth of 40': async ({pass, fail}) => {
		const { container, control } = await createTableWithFieldSortHide();
		...
		cleanup(container);
		pass('FieldSortHide has default maxWidth of 40');
	},

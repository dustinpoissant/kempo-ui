import '../../../src/components/tableControls/HiddenCount.js';
...
const createTableWithHiddenCount = async () => {
	...
	const control = container.querySelector('k-tc-hidden-count');
...
export default {
	...
	*/
	'HiddenCount: should handle missing table gracefully': async ({pass, fail}) => {
		const control = document.createElement('k-tc-hidden-count');

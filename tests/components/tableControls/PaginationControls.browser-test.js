import '../../../src/components/tableControls/FirstPage.js';
import '../../../src/components/tableControls/LastPage.js';
import '../../../src/components/tableControls/NextPage.js';
import '../../../src/components/tableControls/PrevPage.js';
import '../../../src/components/tableControls/PageSelect.js';
import '../../../src/components/tableControls/PageSize.js';
...
export default {
	...
	*/
	'FirstPage: should render first page button': async ({pass, fail}) => {
		const { container, control } = await createTableWithControl('k-tc-first-page');
	...
	'FirstPage: should be disabled on first page': async ({pass, fail}) => {
		const { container, table, control } = await createTableWithControl('k-tc-first-page');
	...
	*/
	'LastPage: should render last page button': async ({pass, fail}) => {
		const { container, control } = await createTableWithControl('k-tc-last-page');
	...
	'LastPage: should be disabled on last page': async ({pass, fail}) => {
		const { container, table, control } = await createTableWithControl('k-tc-last-page');
	...
	*/
	'NextPage: should render next page button': async ({pass, fail}) => {
		const { container, control } = await createTableWithControl('k-tc-next-page');
	...
	'NextPage: should be disabled on last page': async ({pass, fail}) => {
		const { container, table, control } = await createTableWithControl('k-tc-next-page');
	...
	*/
	'PrevPage: should render prev page button': async ({pass, fail}) => {
		const { container, control } = await createTableWithControl('k-tc-prev-page');
	...
	'PrevPage: should be disabled on first page': async ({pass, fail}) => {
		const { container, table, control } = await createTableWithControl('k-tc-prev-page');
	...
	*/
	'PageSelect: should render page select dropdown': async ({pass, fail}) => {
		const { container, control } = await createTableWithControl('k-tc-page-select');
	...
	'PageSelect: should have options for all pages': async ({pass, fail}) => {
		const { container, table, control } = await createTableWithControl('k-tc-page-select');
	...
	*/
	'PageSize: should render page size dropdown': async ({pass, fail}) => {
		const { container, control } = await createTableWithControl('k-tc-page-size');
	...
	'PageSize: should have page size options': async ({pass, fail}) => {
		const { container, table, control } = await createTableWithControl('k-tc-page-size');
	...
	*/
	'controls should update on pageChange event': async ({pass, fail}) => {
		...
		let btnBefore = control.shadowRoot.querySelector('button');
		...
		let btnAfter = control.shadowRoot.querySelector('button');
